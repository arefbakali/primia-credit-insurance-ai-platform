...
def build_commission_model(df):
    """
    Construit un modèle de prédiction de commission optimale basé sur les variables d'entrée.
    """
    ...
    print(f"  [OK] Meilleur modele: {best_name} (MSE: {best_score:.4f})")
    
    return best_model, scaler if best_name == 'Linear Regression' else None
